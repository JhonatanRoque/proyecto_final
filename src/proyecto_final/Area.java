...
public class Area {
	...
	private static double solicitarValor(String texto) {
		while(true){
                    System.out.print(texto); // Controlamos que siempre introduzca un valor numerico
	...
	private static int menu() {
		...
		while(opcion<0) {
                    opcion=entrada.nextInt(); // Controlamos que siempre introduzca un valor numerico
		}
